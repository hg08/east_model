...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics [width=0.75\textwidth] {./imag/corr_of_c_east_model_N128.pdf}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics [width=0.8\textwidth] {./imag/beta_dependence_of_corr_N64_and_N128_step10000_loglog.pdf}
		\setlength{\abovecaptionskip}{0pt}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics [width=0.7\textwidth] {./imag/exact_corr_of_c_east_model_loglog.pdf}
		\setlength{\abovecaptionskip}{0pt}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics [width=0.75\textwidth] {./imag/beta_dependence_of_corr_N9_and_N128_step10000_loglog.pdf}
		\setlength{\abovecaptionskip}{0pt}
...
%A: Consider negative temperature as well.
%\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics [width=0.8\textwidth] {./imag/beta_dependence_of_corr_N64_step10000_transparent_p2-p8.pdf}
		\setlength{\abovecaptionskip}{0pt}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics [width=0.7\textwidth] {./imag/beta_dependence_of_corr_N128_step10000_transparent_p2-p8.pdf}
		\setlength{\abovecaptionskip}{0pt}
		\caption{$C(t)$ for $c=0.2$({\textcolor{red}{red}}), $c=0.4$({\textcolor{green}{green}}), $c=0.6$ ({\textcolor{orange}{orange}}) and $c=0.8$ ({\textcolor{blue}{blue}})  in our simulations  are agree with the simulation results in \textbf{Pitts, Young and Andersen,2000}.}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics [width=0.9\textwidth] {./imag/beta_dependence_of_corr_N128_step10000_p1-p9.pdf}
		\setlength{\abovecaptionskip}{0pt}
...
%		\item $P(m,t)$: The distribution of $m$ for a given $t$ by $P(m;t)$. What's does $P(m,t)$ mean? 
		
%		A: There are two possible answers. 
		
%		\textbf{(1)} Perform one MC simulation, spin $s_{i-1}$, $i =0,\cdots, N-1$,  has been up $m_i$ times. The distribution of $m_i$ is $P_\text{space}(m; t)$; 
		
%		\textbf{(2)} Perform $X$ times simulations, for site $i$, the spin $s_{i-1}$ have $m_x$ times up state. The distribution of $m_x$ is $P_\text{time}(m;t)$.    (\textbf{Sollich 2003}).
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics [width=0.75\textwidth] {../../N_beta_mp_v2s/imag/BETA_dependence_of_corr_N32_and_N128_step10000_loglog.pdf}
		\setlength{\abovecaptionskip}{0pt}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics [width=0.75\textwidth] {./imag/memory_function.pdf}
		\setlength{\abovecaptionskip}{0pt}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics [width=0.7\textwidth] {../../kawasaki_approx/imag/beta_dependence_of_corr_omega0.50_step13_h0.04_loglog.pdf}
		\setlength{\abovecaptionskip}{0pt}

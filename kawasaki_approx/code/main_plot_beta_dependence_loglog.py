...
#Functions
#=========
def plot_multiple_corr(corr_arr,beta_list=beta_list,c_list=c_list,steps=step,h=h):
    ...
    plt.savefig("../imag/beta_dependence_of_corr_step{:d}_h{:4.2f}_loglog.pdf".format(step,h),format='pdf')
    plt.savefig("../imag/beta_dependence_of_corr_step{:d}_h{:4.2f}_loglog.png".format(step,h),format='png')
...
if __name__=='__main__':
    ...
    step = 13
    #beta_list = [-2.2, -1.39, -0.85, -0.40, 0.40, 0.85, 1.39, 2.2]
    #c_list = [0.9, 0.8, 0.7, 0.6, 0.4, 0.3, 0.2, 0.1]
